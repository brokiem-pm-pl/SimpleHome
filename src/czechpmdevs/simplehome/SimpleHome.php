...
use czechpmdevs\simplehome\commands\SavehomesCommand;
...
class SimpleHome extends PluginBase {
	...
	private function registerCommands(): void {
        ...
        $this->commands["savehome"] = new SavehomesCommand($this);
	...
	private function loadHome(mixed $configData): array {
		if(
            !isset($configData[0], $configData[1], $configData[2], $configData[3]) || !is_array($configData) || !is_int($configData[0]) || !is_int($configData[1]) || !is_int($configData[2]) || !is_string($configData[3])
        ) {
    ...
    public function getDisabledWorlds(): array {
        return $this->getConfig()->get("disabled-worlds");
    }
